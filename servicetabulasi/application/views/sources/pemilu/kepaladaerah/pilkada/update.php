		...
		<div class="panel-body">
			<div class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control input-sm" id="add_code" name="add_code" placeholder="KODE PILKADA" value="<?php echo $getDetail["pilkada_code"];?>">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select id="add_level" class="wajib select2" name="add_level" data-placeholder="Pilih Level">
							<option></option>
							<option value="1" <?php echo ($getDetail['pilkada_level'] == 1)?'selected':'' ?> >Presiden</option>
							<option value="2" <?php echo ($getDetail['pilkada_level'] == 2)?'selected':'' ?> >Gubernur</option>
							<option value="3" <?php echo ($getDetail['pilkada_level'] == 3)?'selected':'' ?> >Bupati</option>
							<option value="4" <?php echo ($getDetail['pilkada_level'] == 4)?'selected':'' ?> >Walikota</option>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control input-sm" id="add_name" name="add_name" placeholder="NAMA PILKADA" value="<?php echo $getDetail["pilkada_name"];?>">
					</div>
				</div>
				<div class="form-group">
					...
					<select id="add_lok" class="wajib select2" name="add_lok" data-placeholder="Pilih Lokasi">
							...
							<option value="<?php echo $province["province_id"];?>" <?php echo ((count($getDetail))?(($getDetail["province_id"]==$province["province_id"])?"selected":""):"");?> ><?php echo $province["province_name"];?></option>
							<?php } ?>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control input-sm" id="add_start" name="add_start" placeholder="AWAL PERIODE" value="<?php echo $getDetail["pilkada_periode_start"];?>">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control input-sm wajib" id="add_end" name="add_end" placeholder="AKHIR PERIODE" value="<?php echo $getDetail["pilkada_periode_end"];?>">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-2">
