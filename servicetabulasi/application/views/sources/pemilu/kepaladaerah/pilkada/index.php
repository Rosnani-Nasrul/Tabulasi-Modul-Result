...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Pilkada</h6>
		<a class="pull-right btn btn-xs btn-primary" href='<?php echo base_url();?>pemilu/pilkada/create'>Tambah Data</a>
	</div>
			...
			<div class="col-sm-12">
				<div class="tabbable">
					<ul id="myTab" class="nav nav-tabs tab-bricky">
						<li class="active">
							<a href="#aktif" data-toggle="tab" data-id="1">Pilkada Aktif</a>
						</li>
						<li class="">
							<a href="#nonaktif" data-toggle="tab" data-id="2">Pilkada Nonaktif</a>
						</li>
					</ul>
								...
								<table class="table table-striped table-bordered table-hover" id="dataaktif">
									<thead>
										<tr>
											...
											<th class="text-center">Nama Pilkada</th>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#dataaktif').dataTable( {
			...
			"serverSide": true,
			"bServerSide": true,
			"sAjaxSource": baseurl+"pemilu/pilkada/listdataaktif",
			"aaSorting": [[0, "asc"]],
			"aoColumns": [
		...
		$('#datanonaktif').dataTable( {
			...
			"serverSide": true,
			"bServerSide": true,
			"sAjaxSource": baseurl+"pemilu/pilkada/listdatanonaktif",
			"aaSorting": [[0, "asc"]],
			"aoColumns": [
			{ "bSortable": false, "sClass": "text-center" },
			{ "sClass": "text-left" },
