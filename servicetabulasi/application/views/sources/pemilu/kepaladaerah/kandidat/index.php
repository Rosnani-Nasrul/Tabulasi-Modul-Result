...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Kandidat</h6>
		<a class="pull-right btn btn-xs btn-primary" href='<?php echo base_url();?>pemilu/kandidat/create'>Tambah Data</a>
	</div>
			...
			<div class="col-sm-12">
				<div class="tabbable">
					<ul id="myTab" class="nav nav-tabs tab-bricky">
						<li class="active">
							<a href="#aktif" data-toggle="tab" data-id="1">Kandidat Aktif</a>
						</li>
						<li class="">
							<a href="#nonaktif" data-toggle="tab" data-id="2">Kandidat Nonaktif</a>
						</li>
					</ul>
								...
								<table class="table table-striped table-bordered table-hover" id="dataaktif">
									<thead>
										<tr>
											...
											<th class="text-center">Kode Pilkada</th>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#dataaktif').dataTable( {
			...
			"serverSide": true,
			"bServerSide": true,
			"sAjaxSource": baseurl+"pemilu/kandidat/listdataaktif",
			"aaSorting": [[0, "ASC"]],
			"aoColumns": [
		...
		$('#datanonaktif').dataTable( {
			...
			"serverSide": true,
			"bServerSide": true,
			"sAjaxSource": baseurl+"pemilu/kandidat/listdatanonaktif",
			"aaSorting": [[0, "ASC"]],
			"aoColumns": [
			{ "bSortable": false, "sClass": "text-center" },
			{ "sClass": "text-left" },
