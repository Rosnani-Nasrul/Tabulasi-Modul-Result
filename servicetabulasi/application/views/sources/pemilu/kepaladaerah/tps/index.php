...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>TPS</h6>
		<a class="pull-right btn btn-xs btn-primary" href='<?php echo base_url();?>pemilu/tps/create'>Tambah Data</a>
	</div>
			...
			<div class="col-sm-12">
				<div class="tabbable">
					<ul id="myTab" class="nav nav-tabs tab-bricky">
						<li class="active">
							<a href="#aktif" data-toggle="tab" data-id="1">TPS Aktif</a>
						</li>
						<li class="">
							<a href="#nonaktif" data-toggle="tab" data-id="2">TPS Nonaktif</a>
						</li>
					</ul>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#dataaktif').dataTable( {
			...
			"serverSide": true,
			"bServerSide": true,
			"sAjaxSource": baseurl+"pemilu/tps/listdataaktif",
			"aaSorting": [[0, "asc"]],
			"aoColumns": [
		...
		$('#datanonaktif').dataTable( {
			...
			"serverSide": true,
			"bServerSide": true,
			"sAjaxSource": baseurl+"pemilu/tps/listdatanonaktif",
			"aaSorting": [[0, "asc"]],
			"aoColumns": [
			{ "bSortable": false, "sClass": "text-center" },
			{ "sClass": "text-left" },
