		...
		<div class="panel-body">
			<div class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control input-sm" id="add_code" name="add_code" placeholder="KODE TPS">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select id="add_pilkada" class="wajib select2" name="add_pilkada" data-placeholder="Pilih Pilkada">
							...
							<option value="<?php echo $pilkada["pilkada_id"];?>"><?php echo $pilkada["pilkada_name"];?></option>
							<?php } ?>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control input-sm" id="add_name" name="add_name" placeholder="NAMA TPS">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control input-sm wajib" id="add_address" name="add_address" placeholder="ALAMAT">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control input-sm wajib" id="add_voter" name="add_voter" placeholder="JUMLAH SUARA">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-2">
