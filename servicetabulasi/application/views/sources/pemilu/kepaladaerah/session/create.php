		...
		<div class="panel-body">
			<div class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control input-sm" id="add_code" name="add_code" placeholder="KODE PUTARAN">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control input-sm" id="add_name" name="add_name" placeholder="NAMA PUTARAN">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
					<select multiple="multiple"  class="wajib select2" id="add_candidat" name="add_candidat[]" data-placeholder="Pilih Kandidat">
							<option></option>
				...
				<div class="form-group">
					<label for="add_start" class="col-sm-2 control-label text-right">
						Tanggal Putaran Awal <span class="mandatory">*</span> : 
					</label>
					<div class="col-sm-10">
						<input type="date" class="form-control input-sm" id="add_start" name="add_start" placeholder="TANGGAL AWAL">
					</div>
				</div>
				<div class="form-group">
					<div class="col-sm-2">
