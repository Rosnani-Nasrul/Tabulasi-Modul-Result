...
<div class="panel panel-default">
	<div class="panel-heading">
		<h6 class="panel-title"><i class="icon-copy"></i>Data Kelurahan</h6>
		<a class="pull-right btn btn-xs btn-primary" href='<?php echo base_url();?>datamaster/kelurahan/create'>Tambah Data Kelurahan</a>
	</div>
			...
			<div class="col-sm-12">
				<div class="tabbable">
					<ul id="myTab" class="nav nav-tabs tab-bricky">
						<li class="active">
							<a href="#aktif" data-toggle="tab" data-id="1">Data Kelurahan Aktif</a>
						</li>
						<li class="">
							<a href="#nonaktif" data-toggle="tab" data-id="2">Data Kelurahan Nonaktif</a>
						</li>
					</ul>
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#dataaktif').dataTable( {
			...
			"serverSide": true,
			"bServerSide": true,
			"sAjaxSource": baseurl+"datamaster/kelurahan/listdataaktif",
			"aaSorting": [[0, "desc"]],
			"aoColumns": [
		...
		$('#datanonaktif').dataTable( {
			...
			"serverSide": true,
			"bServerSide": true,
			"sAjaxSource": baseurl+"datamaster/kelurahan/listdatanonaktif",
			"aaSorting": [[0, "desc"]],
			"aoColumns": [
			{ "bSortable": false, "sClass": "text-center" },
			{ "sClass": "text-left" },
